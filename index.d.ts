...
export function scaleCSB(outOption: OutputOption, imgSrcUri: string, param: ScaleCSB): Promise<Response>;

export function transOrientRotate(outOption: OutputOption, imgSrcUri: string, param: OrientRotateParam): Promise<Response>;
export function transResize(outOption: OutputOption, imgSrcUri: string, param: OrientRotateParam): Promise<Response>;
